...
export default class Chat extends Component {
  ...
  componentDidMount(){
    ...
    sk = io.sails.connect("http://192.168.100.10:1337");
  ...
  onSend(messages = []) {
    ...
    sk.post("/v1/chat",{ text : messages[0].text, user_id : this.state.user_id, target_id : this.state.target_id });//Envia a mensagem.
